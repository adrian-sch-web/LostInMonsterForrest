...
namespace DungeonGame.Tests
{
    public class DirectionCheckTests
    {
        ...
        public void DirectionTestRightSuccess()
        {
            ...
            //Act
            bool actualResult = game.DirectionCheck(Direction.Right, new Position(game.MapSize[0] - 2, 10));
        ...
        public void DirectionTestRightFail()
        {
            ...
            //Act
            bool actualResult = game.DirectionCheck(Direction.Right, new Position(game.MapSize[0] - 1, 10));
        ...
        public void DirectionTestDownSuccess()
        {
            ...
            //Act
            bool actualResult = game.DirectionCheck(Direction.Down, new Position(0, game.MapSize[1] - 2));
        ...
        public void DirectionTestDownFail()
        {
            ...
            //Act
            bool actualResult = game.DirectionCheck(Direction.Down, new Position(0, game.MapSize[1] - 1));
